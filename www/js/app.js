...
angular.module('Kidney_Web', ['ui.router', 'ui.bootstrap', 'controllers', 'services', 'filters', 'directives', 'ngTable', 'ngMdIcons', 'checklist-model', 'angular-jwt', ])
                                    ...
                                    return $http({
                                        ...
                                        timeout: 2000
                                            ...
                                            if (refreshToken == Storage.get('refreshToken')) {
                                                console.log("凭证不存在!")
                                                // console.log(options)
                                                var ifrelogin = confirm("您离开太久了，请重新登录。");
                                                if (ifrelogin == true) {
                                                    $state.go('login')
                                                }
                                            }
